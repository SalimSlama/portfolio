...
export const body_color = `hsl(${color},5%, 3%)`;
...
/* When width is greater than 1028px */
export const bigger_big_font_size = '3rem';
export const bigger_h1_font_size = '2.25rem';
export const bigger_h2_font_size = '1.5rem';
export const bigger_h3_font_size = '1.25rem'
export const bigger_normal_font_size = '1rem';
export const bigger_small_font_size = '.875rem';
export const bigger_smaller_font_size = '.813rem';
